...
- (UILabel *)addressLabel {
    if (!_addressLabel) {
        _addressLabel = [[UILabel alloc] initWithFrame:CGRectMake( 0, SizeHeigh(21), SizeWidth(185), SizeHeigh(20))];
        _addressLabel.centerX = self.width/2-SizeWidth(19.5);
...
- (UIImageView *)localImageV {
    if (!_localImageV) {
        _localImageV = [[UIImageView alloc] initWithFrame:CGRectMake(SizeWidth(85), 0, SizeWidth(14.5), SizeHeigh(17))];
        _localImageV.centerY = _addressLabel.centerY;
...
- (UIButton *)otherBtn {
    if (!_otherBtn) {
        ...
        _otherBtn.centerY = self.height/2;
...
- (UIButton *)goodsBtn {
    if (!_goodsBtn) {
        _goodsBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.width/2-SizeWidth(57.5), _otherBtn.origin.y+_otherBtn.height+SizeHeigh(37), SizeWidth(25), SizeHeigh(35))];
...
- (UIButton *)memberBtn {
    if (!_memberBtn) {
        _memberBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.width/2+SizeWidth(49.5), _addressLabel.origin.y+_addressLabel.height+SizeHeigh(15), SizeWidth(44), SizeHeigh(35))];
        _memberBtn.centerY = self.height/2;
...
- (UILabel *)promptLabel {
    if (!_promptLabel) {
        ...
        _promptLabel.centerX = self.width/2-SizeWidth(19.5);
